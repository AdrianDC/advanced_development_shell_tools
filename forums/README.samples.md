[SIZE=4][B][ Samples ] Committing modifications with git ([URL=http://adriandc.github.io/advanced_development_shell_tools/#documentation-sourcesgitcommitrc]git_commit[/URL])[/B][/SIZE]
